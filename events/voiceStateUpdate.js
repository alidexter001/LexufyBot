...
module.exports = async (client, oldState, newState) => {
    ...
    //   if (oldState.channel.id === player.me.voiceChannel) stateChange.type = "LEAVE";
    //   if (newState.channel.id === player.me.voiceChannel) stateChange.type = "JOIN";
    // }
    ...
    // if (!stateChange.channel || stateChange.channel.id !== player.me.voiceChannel)
    //   return;
